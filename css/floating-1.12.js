...
floatingMenu.add = function(obj, options) {
    ...
    if (options == undefined) {
        ...
        floatingArray.push({
            ...
            updateParentHeight: options.updateParentHeight == undefined ?
                false :
            ...
            confinementAreaId: options.confinementArea != undefined &&
                options.confinementArea.substring(0, 1) == '#' ?
                options.confinementArea.substring(1) :
                undefined,

            confinementAreaClassRegexp: options.confinementArea != undefined &&
                options.confinementArea.substring(0, 1) == '.' ?
